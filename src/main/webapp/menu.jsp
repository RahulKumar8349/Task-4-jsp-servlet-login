...
<body>
	...
	<div id="mymenu">
		<ul>
			<h1
				style="color: white; text-decoration: none; text-align: center; font-size: 50px">EMPLOYEE
				MANAGEMENT SYSTEM</h1>
			<li><a href="create.jsp"
				style="color: white; text-decoration: none">CREATE EMPLOYEE</a></li>
